        ...
        <div className="w-full h-screen ">
          <div className="border-b border-[#999999] flex items-center justify-between mb-[32px]">
            <div className="flex items-center gap-[16px] pl-[32px] pr-[18px] ">
              <Link
                to={-1}
                state={filteredJobs(allNewJobs?.jobs)}
