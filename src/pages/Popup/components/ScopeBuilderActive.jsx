...
const ScopeBuilderActive = ({ fill = '#66DC78' }) => {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className=" flex-1 flex flex-col px-[32px] ">
        <div className="flex items-center gap-[16px] ">
          ...
          <div className="my-[32px]">
            <div className="flex flex-col gap-[8px]">
              <span className="uppercase text-[20px] ">ScopeBuilder</span>
        ...
        <div className="h-full w-full bg-gradient-green rounded-[10px] flex items-center justify-center">
          <div>
            ...
            <div className="w-fit mx-auto">
              <Link
                to={'/Home'}
                className=" bg-white font-medium uppercase text-[#66DC78] text-[16px] py-[16px] px-[32px] rounded-[4px] "
              >
...
export default ScopeBuilderActive;
