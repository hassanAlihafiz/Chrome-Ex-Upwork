...
const ButtonLG = ({ text, styles, fill, link, status }) => {
  return (
    <Link
      to={link}
      className={` border 
      border-[#FFFFFF66] flex justify-between items-center p-[22px] rounded-[10px] w-full
      ${status ? 'bg-gradient-green' : 'bg-gradient-blue'}
      `}
    >
