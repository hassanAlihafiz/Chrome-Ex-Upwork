      ...
      <div>
        ...
        <div className="my-[32px]">
          ...
          <span className=" text-[12px] block text-center ">
            It looks like we ran into trouble connecting your <br />
            account. Would you like to try again?
          </span>
        </div>
        <div className="w-fit mx-auto">
          <Link
            to={'/KeywordsConnected'}
            className=" mr-[10px] bg-white font-medium uppercase text-[#FF1818] text-[16px] py-[16px] px-[32px] rounded-[4px] "
          >
            cancel
          </Link>
          <Link
